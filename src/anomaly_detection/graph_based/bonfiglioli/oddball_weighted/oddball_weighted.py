...
# Oddball Algorithm for Weighted Networks of Bonfiglioli lab data - Egonet Weight Power Law
...
output_dir = output_base / 'oddball_scores' / 'weighted_scores'
plots_dir = output_base / 'oddball_fits' / 'weighted_fits'
