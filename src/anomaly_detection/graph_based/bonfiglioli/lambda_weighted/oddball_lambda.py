...
# Paths
input_dir = Path('/home/projects/safe/outputs/networks/grafi/bonfiglioli_graphs/weighted')
output_base = Path('/home/projects/safe/outputs/networks/oddball/bonfiglioli')
output_dir = output_base / 'oddball_scores' / 'lambda_scores'
plots_dir = output_base / 'oddball_fits' / 'lambda_fits'
...
# Define target column keys to filter graphs
...
print(f"\nSuccessfully loaded {len(graphs)} graphs (filtered by target keys)")
