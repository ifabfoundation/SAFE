...
# Plot Top 40 Oddball Nodes (Dominant Pair - lambda_i ~ W_i^beta) on Tampieri Time Series
...
# Paths
oddball_dir = Path('/home/projects/safe/outputs/networks/oddball/weighted/ODB_3_scores')
data_file = Path('/home/projects/safe/data/processed-datasets/processed_streaming_row_continuous.csv')
output_dir = Path('/home/projects/safe/outputs/networks/oddball/oddball_vs_timeseries/dominantpair')
...
# Graph format: G_NVG_bonfi_gb1_p3_acc_cfa or G_HVG_bonfi_gb1_p3_acc_cfa
# Column format: bonfi/gb1_p3_acc_cfa
def graph_to_column(graph_name):
    """
    Extract column name from graph name.
    G_NVG_bonfi_gb1_p3_acc_cfa -> bonfi/gb1_p3_acc_cfa
    """
    ...
    # Replace underscores with slashes in the bonfi part
    # bonfi_gb1_p3_acc_cfa -> bonfi/gb1_p3_acc_cfa
...
for oddball_file in oddball_files:
    ...
    try:
        ...
        scatter = ax.scatter(top_nodes, ts_data[top_nodes], 
                            ...
                            label=f'Top 40 Oddball nodes', zorder=5)
        ...
        ax.set_title(f'Top 40 Oddball Nodes - {graph_name}\n(oddball: dominant pair λ_i ~ W_i^β)', fontsize=14, fontweight='bold')
