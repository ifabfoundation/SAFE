...
# Plot Top 40 Oddball Nodes (Weighted - W_i ~ E_i^beta) on Tampieri Time Series
...
output_dir = Path('/home/projects/safe/outputs/networks/oddball/oddball_vs_timeseries/heavyvicinity')
