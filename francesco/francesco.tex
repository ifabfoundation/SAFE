...
% environment per cverbatim
\newenvironment{cverbatim}
  {\begin{center}\begin{minipage}{0.7\linewidth}\begin{verbatim}}
  {\end{verbatim}\end{minipage}\end{center}}

\title{Francesco Simoni}
\begin{document}

\begin{titlepage}
		\centering
		{\Huge\textbf{Anomaly Detection Project}}\\
		\vspace{0.5cm}
		{\Large 2025}\\
		\vspace{8cm}\
		{\LARGE \textbf{Quantization and Hardware Deployment Section}}\\
		\vspace{0.5cm}
		{\Large \textit{Technical report on developing, quantizing, and deploying a CNN/LSTM model on STM32 microcontrollers with serial and Modbus RTU integration.}}\\
		\vspace{10cm}
		{\large Francesco Simoni}
	\end{titlepage}
